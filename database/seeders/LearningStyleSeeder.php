    ...
    public function run()
    {
        ...
        LearningStyle::insert([
            ...
            [
                ...
                "created_at"=>now(),
                "updated_at"=>now(),
                "image"=>"media/tutor/autoridad_formal.png",
            ],
            [
                ...
                "created_at"=>now(),
                "updated_at"=>now(),
                "image"=>"media/tutor/modelo_personal.png",
            ],
            [
                ...
                "created_at"=>now(),
                "updated_at"=>now(),
                "image"=>"media/tutor/facilitador.png"
            ],
            [
                "style_es"=>"Delegador",
                "style_en"=>"Delegator",
                ...
                "created_at"=>now(),
                "updated_at"=>now(),
                "image"=>"media/tutor/delegador.png"
            ]
        ]);
    }
}
